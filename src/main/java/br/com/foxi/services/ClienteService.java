...
public class ClienteService {
	...
	public void delete(Integer id) {
		...
		try {
			...
			throw new DataIntegrityException("Não é possivel excluir o cliente pois possui registros vinculados");
 		}
	}
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		Cliente cli = new Cliente(null,objDto.getNome(),objDto.getEmail(),objDto.getDocumento(),TipoCliente.toEnum(objDto.getTipo()),cpe.encode(objDto.getSenha()));
